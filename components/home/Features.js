    ...
    <Button size="lg" className="mt-12 bg-[#FF4D5F] text-[#FFF5E4] hover:bg-[#FF7679]">Start Your Journey</Button>
      ...
      <div className="flex space-x-4">
        <div className="flex flex-col space-y-8">
          <div className="bg-white w-48 rounded-3xl p-10 flex flex-col space-y-10 shadow-xl">
            <ShoppingCart className="text-red-400" size={40} strokeWidth={2} />
          ...
          <div className="bg-white w-48 rounded-3xl p-10 flex flex-col space-y-10 shadow-xl transform rotate-12">
            <Handshake className="text-rose-400" size={40} strokeWidth={2} />
            <p className="text-3xl">
              Sell
              <br />
              Shares
        ...
        <div className="flex flex-col space-y-12">
          <div className="bg-white w-48 rounded-3xl p-10 flex flex-col space-y-10 shadow-xl transform rotate-12">
            <DollarSign className="text-teal-400" size={40} strokeWidth={2} />
            <p className="text-3xl">
              Earn
              <br />
              Rent
          ...
          <div className="bg-white w-48 rounded-3xl p-10 flex flex-col shadow-xl space-y-10 transform -rotate-12">
            <ScrollText className="text-indigo-400" size={40} strokeWidth={2} />
            <p className="text-3xl">
              List
              <br />
              Anything
